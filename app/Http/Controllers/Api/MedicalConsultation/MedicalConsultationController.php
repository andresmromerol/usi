    ...
    public function cancelMedicalConsultation(Request $request)
    {
        ...
        try {
            ...
            if ($timeAllowedCancellationHasExpired) {
                return $responseApi->response("El periodo de tiempo para cancelar la cita medica ha vencido", $timeAllowedCancellationHasExpired, [], 214, "ERROR", false, 500);
            ...
            if ($wasUpdated) {
                return $responseApi->response("Citas medica cancelada", [], [], 212, "OK", true, 212);
    ...
    public function create(Request $request)
    {
        ...
        try {
            ...
            $defaultValues = [
                ...
                'CCMFECCIT' => Carbon::parse($request->feccit)->format('Y-m-d H:i:s'), //FECHA INICIAL CITA
                'CCMFINCIT' => Carbon::parse($request->fincit)->format('Y-m-d H:i:s'), //FECHA FINAL CITA
                'CCMESTADO' => 1, // asignado - ESTADO CITA
                ...
                'CCMFECASI' => Carbon::parse($request->fecasi)->format('Y-m-d H:i:s'), //FECHA ASIGNACION
                ...
                'CCMFECPAC' => Carbon::parse($request->fecpac)->format('Y-m-d H:i:s'), //FECHA REQUIERE CITA
